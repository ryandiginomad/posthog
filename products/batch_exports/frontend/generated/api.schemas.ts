...
export interface DatabricksDestinationRequestApi {
    ...
    /** ID of a databricks-kind Integration. Use integrations-list to find one. */
...
export interface AzureBlobDestinationRequestApi {
    ...
    /** ID of an azure-blob-kind Integration. Use integrations-list to find one. */
    integration_id: number
    config: AzureBlobDestinationConfigApi
}

export type OtherDestinationRequestApiType =
    (typeof OtherDestinationRequestApiType)[keyof typeof OtherDestinationRequestApiType]

export const OtherDestinationRequestApiType = {
    S3: 'S3',
    Snowflake: 'Snowflake',
    Postgres: 'Postgres',
    Redshift: 'Redshift',
...
/**
 * Request shape for destinations that keep credentials in config (no Integration).
 */
export interface OtherDestinationRequestApi {
    type: OtherDestinationRequestApiType
    /**
     * Optional Integration ID (only BigQuery supports this).
     * @nullable
     */
    integration_id?: number | null
    /** Destination-specific configuration, including credentials. */
    config: unknown
}
...
* `every 15 minutes` - every 15 minutes */
    ...
    paused?: boolean
    /**
     * Time before which no runs will be triggered.
     * @nullable
     */
    start_at?: string | null
    /**
     * Time after which no runs will be triggered.
     * @nullable
     */
    end_at?: string | null
    /** Optional HogQL SELECT defining a custom per-record shape when `schema` is set. */
    hogql_query?: string
    filters?: unknown | null
 ...
 * `NoOp` - NoOp
 */
export type OtherDestinationRequestTypeEnumApi =
    (typeof OtherDestinationRequestTypeEnumApi)[keyof typeof OtherDestinationRequestTypeEnumApi]

export const OtherDestinationRequestTypeEnumApi = {
    S3: 'S3',
    Snowflake: 'Snowflake',
    Postgres: 'Postgres',
    Redshift: 'Redshift',
