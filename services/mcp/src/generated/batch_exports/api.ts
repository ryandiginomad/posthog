...
export const BatchExportsList2Params = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
...
export const BatchExportsList2QueryParams = /* @__PURE__ */ zod.object({
    limit: zod.number().optional().describe('Number of results to return per page.'),
    offset: zod.number().optional().describe('The initial index from which to return the results.'),
})

export const BatchExportsCreate2Params = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to /api/projects/."
...
export const batchExportsCreate2BodyDestinationOneOneConfigUseVariantTypeDefault = true
export const batchExportsCreate2BodyDestinationOneOneConfigUseAutomaticSchemaEvolutionDefault = true
export const batchExportsCreate2BodyDestinationOneTwoConfigPrefixDefault = ``
export const batchExportsCreate2BodyDestinationOneTwoConfigFileFormatDefault = `JSONLines`
                        ...
                        config: zod
                            .object({
                                ...
                                use_variant_type: zod
                                    .boolean()
                                    .default(batchExportsCreate2BodyDestinationOneOneConfigUseVariantTypeDefault)
                                    .describe('Whether to use the Databricks VARIANT type for JSON-like columns.'),
                                use_automatic_schema_evolution: zod
                                    .boolean()
                                    .default(
                                        batchExportsCreate2BodyDestinationOneOneConfigUseAutomaticSchemaEvolutionDefault
                                    )
                                    .describe(
                    ...
                    .object({
                        ...
                        config: zod
                            .object({
                                ...
                                prefix: zod
                                    .string()
                                    .default(batchExportsCreate2BodyDestinationOneTwoConfigPrefixDefault)
                                ...
                                file_format: zod
                                    ...
                                    .default(batchExportsCreate2BodyDestinationOneTwoConfigFileFormatDefault)
                                    .describe(
                ...
                zod
                    .object({
                        ...
                        integration_id: zod
                            .number()
                            .nullish()
                            .describe('Optional Integration ID (only BigQuery supports this).'),
                        config: zod.unknown().describe('Destination-specific configuration, including credentials.'),
                    })
                    .describe('Request shape for destinations that keep credentials in config (no Integration).'),
            ])
...
export const BatchExportsRetrieve2Params = /* @__PURE__ */ zod.object({
...
export const BatchExportsPartialUpdate2Params = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this batch export.'),
    project_id: zod
        .string()
        .describe(
...
export const batchExportsPartialUpdate2BodyDestinationOneOneConfigUseVariantTypeDefault = true
export const batchExportsPartialUpdate2BodyDestinationOneOneConfigUseAutomaticSchemaEvolutionDefault = true
export const batchExportsPartialUpdate2BodyDestinationOneTwoConfigPrefixDefault = ``
export const batchExportsPartialUpdate2BodyDestinationOneTwoConfigFileFormatDefault = `JSONLines`
                    ...
                    .object({
                        ...
                        config: zod
                            .object({
                                ...
                                use_variant_type: zod
                                    .boolean()
                                    .default(batchExportsPartialUpdate2BodyDestinationOneOneConfigUseVariantTypeDefault)
                                    .describe('Whether to use the Databricks VARIANT type for JSON-like columns.'),
                                use_automatic_schema_evolution: zod
                                    .boolean()
                                    .default(
                                        batchExportsPartialUpdate2BodyDestinationOneOneConfigUseAutomaticSchemaEvolutionDefault
                                    )
                                    .describe(
                                        'Whether to let Databricks evolve the destination table schema automatically.'
                                    ),
                    ...
                    .object({
                        ...
                        config: zod
                            .object({
                                ...
                                prefix: zod
                                    .string()
                                    .default(batchExportsPartialUpdate2BodyDestinationOneTwoConfigPrefixDefault)
                                    .describe('Object key prefix applied to every exported file.'),
                                compression: zod
                                    .union([
                                        zod
                                ...
                                file_format: zod
                                    .enum(['JSONLines', 'Parquet'])
                                    .describe('* `JSONLines` - JSONLines\n* `Parquet` - Parquet')
                                    .default(batchExportsPartialUpdate2BodyDestinationOneTwoConfigFileFormatDefault)
                                    .describe(
                                        'File format used for exported objects.\n\n* `JSONLines` - JSONLines\n* `Parquet` - Parquet'
                                    ),
                                max_file_size_mb: zod
...
export const BatchExportsDestroy2Params = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this batch export.'),
    project_id: zod
        .string()
        .describe(
