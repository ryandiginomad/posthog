...
export const batchExportsCreate2BodyDestinationOneConfigOneOneUseVariantTypeDefault = true
export const batchExportsCreate2BodyDestinationOneConfigOneOneUseAutomaticSchemaEvolutionDefault = true
export const batchExportsCreate2BodyDestinationOneConfigOneTwoPrefixDefault = ``
export const batchExportsCreate2BodyDestinationOneConfigOneTwoFileFormatDefault = `JSONLines`
...
export const BatchExportsCreate2Body = /* @__PURE__ */ zod
    .object({
                    ...
                    .union([
                        zod
                            .object({
                                ...
                                use_variant_type: zod
                                    .boolean()
                                    .default(batchExportsCreate2BodyDestinationOneConfigOneOneUseVariantTypeDefault)
                                    .describe('Whether to use the Databricks VARIANT type for JSON-like columns.'),
                                use_automatic_schema_evolution: zod
                                    .boolean()
                                    .default(
                                        batchExportsCreate2BodyDestinationOneConfigOneOneUseAutomaticSchemaEvolutionDefault
                                    )
                                    .describe(
                        ...
                        zod
                            .object({
                                ...
                                prefix: zod
                                    .string()
                                    .default(batchExportsCreate2BodyDestinationOneConfigOneTwoPrefixDefault)
                                ...
                                file_format: zod
                                    ...
                                    .default(batchExportsCreate2BodyDestinationOneConfigOneTwoFileFormatDefault)
                                    .describe(
        ...
        hogql_query: zod
            ...
            .optional()
            .describe(
                'Optional HogQL SELECT query used when `schema` is set; defines the custom shape of each exported record.'
            ),
...
export const batchExportsPartialUpdate2BodyDestinationOneConfigOneOneUseVariantTypeDefault = true
export const batchExportsPartialUpdate2BodyDestinationOneConfigOneOneUseAutomaticSchemaEvolutionDefault = true
export const batchExportsPartialUpdate2BodyDestinationOneConfigOneTwoPrefixDefault = ``
export const batchExportsPartialUpdate2BodyDestinationOneConfigOneTwoFileFormatDefault = `JSONLines`
                    ...
                    .union([
                        zod
                            .object({
                                ...
                                use_variant_type: zod
                                    .boolean()
                                    .default(
                                        batchExportsPartialUpdate2BodyDestinationOneConfigOneOneUseVariantTypeDefault
                                    )
                                    .describe('Whether to use the Databricks VARIANT type for JSON-like columns.'),
                                use_automatic_schema_evolution: zod
                                    .boolean()
                                    .default(
                                        batchExportsPartialUpdate2BodyDestinationOneConfigOneOneUseAutomaticSchemaEvolutionDefault
                                    )
                                    .describe(
                                        'Whether to let Databricks evolve the destination table schema automatically.'
                                    ),
                        ...
                        zod
                            .object({
                                ...
                                prefix: zod
                                    .string()
                                    .default(batchExportsPartialUpdate2BodyDestinationOneConfigOneTwoPrefixDefault)
                                    .describe('Object key prefix applied to every exported file.'),
                                compression: zod
                                    .union([
                                        zod
                                ...
                                file_format: zod
                                    .enum(['JSONLines', 'Parquet'])
                                    .describe('* `JSONLines` - JSONLines\n* `Parquet` - Parquet')
                                    .default(batchExportsPartialUpdate2BodyDestinationOneConfigOneTwoFileFormatDefault)
                                    .describe(
                                        'File format used for exported objects.\n\n* `JSONLines` - JSONLines\n* `Parquet` - Parquet'
                                    ),
                                max_file_size_mb: zod
